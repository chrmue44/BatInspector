...
namespace BatInspector.Controls
{
  ...
  public class DropDownCmds
  {

    public ICommand ShowHelp => new RelayCommand(() =>
    {
      string helpFileName = AppDomain.CurrentDomain.BaseDirectory + "/doc/BatInspector.pdf";
      try
      {
      ...
      {
        DebugLog.log("could not open help file: ", enLogType.ERROR);
      }
    });

    public ICommand ShowBatInfo => new RelayCommand(() =>
    {
      MessageBox.Show("show bat info");
    });
