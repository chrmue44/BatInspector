...
namespace BatInspector.Forms
{
  ...
  {
    private bool _guanoChanged = false;
      ...
      try
      {
        ...
        if (openFileDialog.ShowDialog() == true)
        {
          ...
          if (App.Model.WavFile.readFile(wavFile) == 0)
          {
            ...
            {
              _dgGuano.AutoGeneratedColumns += updateColumnBehaviour;
    ...
    private void updateColumnBehaviour(object? s, EventArgs e)
    {
      Style grayTextStyle = new Style(typeof(System.Windows.Controls.DataGridCell));
      grayTextStyle.Setters.Add(new Setter(System.Windows.Controls.DataGridCell.ForegroundProperty, System.Windows.Media.Brushes.Gray));
      _guanoChanged = false;
      _dgGuano.Columns[0].IsReadOnly = true;
      _dgGuano.Columns[0].CellStyle  = grayTextStyle;
      _dgGuano.Columns[1].IsReadOnly = true;
      _dgGuano.Columns[1].CellStyle = grayTextStyle;
      _dgGuano.Columns[2].IsReadOnly = false;
      _dgGuano.Columns[3].IsReadOnly = true;
      _dgGuano.Columns[3].CellStyle = grayTextStyle;
      _dgGuano.AutoGeneratedColumns -= updateColumnBehaviour;
    }
    ...
    {
      if (_guanoChanged)
        App.Model.WavFile.updateGuanoFromItems();
    ...
    private void _dgGuano_CellEditEnding(object sender, System.Windows.Controls.DataGridCellEditEndingEventArgs e)
    {
      _guanoChanged = true;
    }
  }
