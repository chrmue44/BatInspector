...
namespace BatInspector
{
  ...
  public class ZoomView
  {
    ...
    public ZoomView(ColorTable colorTable, ProcessRunner pr, ModelState modelState)
    {
      ...
      _tmp1Wav = Path.Combine(AppParams.AppParamsPath, "temp1.wav");
      _tmp2Wav = Path.Combine(AppParams.AppParamsPath, "temp2.wav");
    ...
    {
      _wf = new Waterfall(wavName, _colorTable, AppParams.FFT_WIDTH, AppParams.Inst.BlackLevel);
