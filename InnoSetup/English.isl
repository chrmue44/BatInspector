...
WelcomeLabel2=This will install [name/ver] on your computer.%n%nPlease uninstall older versions of BatInspector before continuing.%n%nBe sure to have a working internet connection. Otherwise the installation will fail.
...
msgInstBats=Installation: for bats only; all AI models
msgInstBirds=Installation: for birds only
msgInstBatBd2=Installation: for bats only; only AI model BatDetect2
msgBatsBirds=Installation: for bats(only AI-Modell BatDetect2) & birds
msgInstCustom=Custumized installation
cmpBd2=AI Classifier BatDetect2
cmpBbnet=AI Classifier Batty BirdNet
cmpBirdNet=AI Classifier BirdNET
cmpPython=Python Environment