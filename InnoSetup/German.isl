...
WelcomeLabel2=Dieser Assistent wird jetzt [name/ver] auf Ihrem Computer installieren.%n%nBitte deinstallieren Sie eine eventuell vorhandene ältere Version, bevor Sie fortfahren!%n%nStellen Sie sicher, dass eine Internetverbindung vorhanden ist, anderenfalls schlägt die Insatallation fehl.
...
msgInstBats=Teilinstallation: Analysetools nur Fledermäuse; alle KI-Modelle
msgInstBirds=Teilinstallation: Analysetools nur Vögel
msgInstBatBd2=Teilinstallation: Analysetools nur Fledermäuse; nur KI-Modell BatDetect2
msgBatsBirds=Teilinstallation: Analysetools Fledermäuse(nur KI-Modell BatDetect2) & Vögel
msgInstCustom=Benutzerdefinierte Installation
cmpBd2=KI Klassifizierer BatDetect2
cmpBbnet=KI Klassifizierer Batty BirdNet
cmpBirdNet=KI Klassifizierer BirdNET
cmpPython=Python Umgebung