...
## Main features
- easy import of BatSpy projects or WAV Files from many diiferent recording devices
...
- scriptable
- connectivity to mySQL data base 
...
## Deployment
- integrated installer project that installs software, python and the AI model
